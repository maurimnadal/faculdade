...
export default function Index() {
  ...
  const [posts, setPosts] = useState<{ id: number, name: string, username: string, email: string}[] | null>(null)
  ...
  const filteredPosts = posts?.filter(p => p.username.includes(search))
